...
def run_gridworld_from_text_file():
    ...
    Check core/envs/textworld_map_files for examples or the _create_textworld_from_text() function within the environment.
    """
    ...
    # env = GridWorldEnv(textworld_fp='../core/envs/textworld_map_files/maze_21x21.txt')
    # env = GridWorldEnv(textworld_fp='../core/envs/textworld_map_files/maze_101x101.txt')
    for i_episode in range(1):
        observation = env.reset()
        for t in range(1000):
...
def run_lever_gridworld_from_text_file():
    # env = GridWorldEnv(textworld_fp='../core/envs/textworld_map_files/lever_level_1.txt')
    env = GridWorldEnv(textworld_fp='../core/envs/textworld_map_files/lever_level_2.txt')
    # env = GridWorldEnv(textworld_fp='../core/envs/textworld_map_files/lever_level_3.txt')
